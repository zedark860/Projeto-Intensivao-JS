...
export function desenharProdutoCarrinhoSimples(idProduto, idContainerHtml, quantidadeProduto){
    ...
    const cartaoProdutoCarrinho = `<img src="assets/img/${produto.imagem}" alt="Carrinho: ${produto.nome}" class="shadow-md shadow-black h-24 rounded-md hover:scale-105 duration-500">
